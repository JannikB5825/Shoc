...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		KC_NO, KC_LGUI, KC_LALT, KC_SPC, MO(1), KC_SPC, KC_NO, KC_LCTL, 
		KC_BSPC, KC_MINS, KC_0, KC_9, KC_8, KC_I, KC_O, KC_P, 
		KC_RGHT, KC_DOWN, KC_LEFT, KC_EQL, KC_UP, KC_QUES, KC_RABK, KC_LABK, 
		KC_RCBR, KC_LCBR, KC_BSLS, KC_ENT, KC_DQUO, KC_COLN, KC_L, KC_K),
